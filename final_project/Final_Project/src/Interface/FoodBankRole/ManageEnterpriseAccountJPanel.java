...
public class ManageEnterpriseAccountJPanel extends javax.swing.JPanel {
    ...
    public ManageEnterpriseAccountJPanel(JPanel userProcessContainer, Business system, Enterprise enterprise) {
        initComponents();
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        Role selectedRole = new AgentRole();
    ...
    public void populateTabel() {
        ...
        for(Account acc: selectedEnt.getAccountDirectory().getAccountCatalog()) {
    ...
    public void populateEmployee() {
        ...
        for(P p: selectedEnt.getPersonDirectory().getPersonDir()) {
            Person tempperson = (Person)p;
            employeeComboBox.addItem(tempperson);
        }
    }
